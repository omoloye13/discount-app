...
else if (itemQuantity > 10 && itemQuantity <=12) {
    document.getElementById("display").innerHTML = (`You bought ${itemQuantity} ${ProductName} you will be paying #${itemQuantity*(itemPrice-discount50)} at 50% discount` );
    }
else{
